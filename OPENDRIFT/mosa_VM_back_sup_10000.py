...
o.run(steps=25920, time_step=-100, time_step_output=3600, outfile='/data2/matlab/MOSA_BGQ/Valentina/mosa_opendrift_sup_VM_10000.nc')

#%%
# Print and plot results
# print(o)
o.plot(buffer=.2, fast=True, linecolor = 'z',filename='/data2/matlab/MOSA_BGQ/Valentina/mosa_opendrift_sup_VM_10000.png')
o.animation(filename="/data2/matlab/MOSA_BGQ/Valentina/mosa_opendrift_sup_VM_10000.mp4",linecolor="z",fast = True)
