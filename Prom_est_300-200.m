...
% interpolar un campo en rho puntos a un campo en v puntos


v_ver=rho2v_2d(prom_esta_v(:,:,1));
v_oto=rho2v_2d(prom_esta_v(:,:,2));
v_inv=rho2v_2d(prom_esta_v(:,:,3));
v_pri=rho2v_2d(prom_esta_v(:,:,4));

u_ver=rho2u_2d(prom_esta_u(:,:,1));
u_oto=rho2u_2d(prom_esta_u(:,:,2));
u_inv=rho2u_2d(prom_esta_u(:,:,3));
u_pri=rho2u_2d(prom_esta_u(:,:,4));
...
% m_quiver(lon1,lat1,u_ver,v_ver);
caxis([-0.7202 0.5646])
