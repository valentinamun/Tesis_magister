...
figure()
hold on
pcolor(lat_mosa12(:,12:53),z_mosa12(:,12:53),uuvel(:,12:53))
C = contour(lat_mosa12(:,12:53),z_mosa12(:,12:53),uuvel(:,12:53),[-100 0 100],...
            '--w','LineWidth',2);
...
dy=s_rho*hh'; %Largo de cada celda

A=abs(dy*dx); %Area de la celda

T=A.*uuvel; %Transporte
